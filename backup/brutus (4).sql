...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/06/2025 às 01:20
...
(5, 20, 1, '2025-06-04 23:25:32'),
(6, 20, 3, '2025-06-04 20:15:24'),
(7, 20, 3, '2025-06-04 20:15:36');
...
CREATE TABLE `pedidos` (
  `cod_pedido` int(11) NOT NULL,
  `datahora_pedido` timestamp NOT NULL DEFAULT current_timestamp(),
...
(14, '2025-06-04 21:21:30', 48.8, 13, 'cartao', 2, 15),
(15, '2025-06-04 21:21:30', 48.8, 13, 'cartao', 2, 15),
(16, '2025-06-04 21:21:30', 0, 13, 'cartao', 0, 15),
(17, '2025-06-04 21:21:30', 0, 13, 'cartao', 0, 15),
(18, '2025-06-04 21:21:30', 34, 13, 'cartao', 1, 15),
(19, '2025-06-04 21:21:30', 19.9, 14, 'dinheiro', 1, 17),
(20, '2025-06-04 21:25:32', 34, 13, 'cartao', 1, 16);
...
--
ALTER TABLE `hist_status_ped`
  MODIFY `cod_hist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `status_pedidos`
  MODIFY `cod_status_pedidos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
